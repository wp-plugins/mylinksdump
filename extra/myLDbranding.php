...
if (!empty($pre_result)){
 $pre_link  = '<li><a href="'.get_settings('siteurl').'/myLDlinker.php?url='.$pre_result['link_id'].'" target="main">';
...
if (!empty($next_result)){
 $next_link  = '<li><a href="'.get_settings('siteurl').'/myLDlinker.php?url='.$next_result['link_id'].'" target="main">';
